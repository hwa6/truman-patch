              ...
              if (act) {
                ...
                for (var i = 0; i < arrayLength; i++) {
                  if (myArray[i].includes('@') == true) {
                    //if the element contains @ sign
                    var userName = myArray[i].substring(
                      myArray[i].lastIndexOf('@') + 1
                    ); //we need to extract the username after the @ sign
                ...
                for (var i = 0; i < myArray1.length; i++) {
                  if (myArray1[i].startsWith('#')) {
                    var rawTag = myArray1[i].substring(
                      myArray1[i].indexOf('#') + 1
                    );
                    if (rawTag) {
                      var tag = '';
                      var chars = rawTag.split('');
                      for (var j = 0; j < chars.length; j++) {
                        //add only alphanumeric characters in the valid tag
                          ...
                          if (rawTag) {
                            ...
                            if (tag !== '') {
                              let link =
                                ...
                                tag +
                                '</a>';
                              new_replies.body = new_replies.body.replace(
                                '#' + tag,
                                link
                              );
                            }
